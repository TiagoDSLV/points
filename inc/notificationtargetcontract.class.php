...
class PluginCreditNotificationTargetContract extends NotificationTarget
{
    ...
    public function addDataForTemplate($event, $options = [])
    {
        ...
        $req = $DB->request(
            [
                ...
                'WHERE'  => [
                    'plugin_credit_contracts_id' => $this->obj->getField('id'),
                ],
            ],
        );
        $data = $req->current();
        ...
        $this->data['##credit.contract##'] = Dropdown::getDropdownName(
            'glpi_contracts',
        ...
        $this->data['##lang.credit.name##']                    = PluginCreditContract::getTypeName();
    ...
    {
        $tags = [
            'credit.name'                    => PluginCreditContract::getTypeName(),
    ...
    public static function install(Migration $migration)
    {
        ...
        if ($templates_id_quantity) {
            ...
            $notifications_count_quantity = countElementsInTable(
                $notification->getTable(),
                ['itemtype' => 'PluginCreditContract', 'event' => 'lowcredits'],
            );
